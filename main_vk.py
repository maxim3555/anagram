...
#основной цикл
while True:
    schet = schet_nezablokirovan[schet22-1]
    ...
    vk_repost = Vk_prosto_repost(group_id=group_id, post_id=post_id, group_full=group_full,
                                 access_token=list1['J'][schet].value)
    vk_otver_na_svoi_koment = Vk_prosto_otvet_na_svoi_koment( post_id=post_id,group_id=group_id, group_full=group_full,
                                 access_token=list1['J'][schet].value,schet=schet)
    ...
    #функция отправки
        ...
        vk_otver_na_svoi_koment.leave_reply(list1['E'][schet].value,slovo)#ответ на  свой коментарий
